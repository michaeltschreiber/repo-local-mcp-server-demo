...
> **Generated by [folder2md4llms](https://github.com/henriqueslab/folder2md4llms) v0.5.16** - Structured folder analysis for LLM consumption
> Source: `D:\repos\github\repo-local-mcp-server-demo` • Generated: 2025-12-17 19:51:39

**Stats:** 11 files • 116,288 tokens
...
### Token Estimation
- **Estimated Tokens:** 116,288


## 📄 Source Code

### 📄 `mcp\repo_rg\pyproject.toml`
...
[tool.uv]
# No special config required; kept for clarity.
```

### 📄 `mcp\demosquare\pyproject.toml`
...
### 📄 `mcp\sem_ver\tests\test_sem_ver.py`
